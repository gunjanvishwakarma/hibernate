package com.novell.cve.matching;

import java.text.ParseException;
import java.util.Hashtable;

import com.novell.cve.common.LogicalValue;
import com.novell.cve.common.Utilities;
...
public class CPENameMatcher {
    ...
    private Object compare(Object source, Object target) {
        // matching is case insensitive, convertXMLGregorianCalendarToDateTime strings to lowercase.
        if (isString(source)) {
